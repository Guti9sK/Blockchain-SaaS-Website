    ...
    <footer className="py-24 bg-zinc-950">
      <div className="padding-container">
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex text-zinc-500 font-heading font-black gap-12 transition">
            <a href="/" className="hover:text-zinc-300 duration-300">Home</a>
            <a href="/blog" className="hover:text-zinc-300 duration-300">Blog</a>
            <a href="/careers" className="hover:text-zinc-300 duration-300">Carrers</a>
            <a href="/contact" className="hover:text-zinc-300 duration-300">Contact</a>
          </nav>
        </div>
